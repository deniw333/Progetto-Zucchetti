...
const MuseodellaStampaAndreaSchiavi = L.marker([dati[0].lat, dati[0].lon]).addTo(mappa);
MuseodellaStampaAndreaSchiavi.bindPopup("<h3>"+ dati[0].nome +"</h3><p>"+ dati[0].descrizione +"</p><p><strong>Indirizzo:</strong> "+ dati[0].indirizzo +"</p><p><strong>Orari:</strong> "+ dati[0].orari +"</p>");

const CentroStoricodiLodi = L.marker([dati[1].lat, dati[1].lon]).addTo(mappa);
...
const RistoranteFuoriModena = L.marker([dati[2].lat, dati[2].lon]).addTo(mappa);
...
const PizzeriaArmandino = L.marker([dati[4].lat, dati[4].lon]).addTo(mappa);
...
const MuseoEttoreArchinti = L.marker([dati[5].lat, dati[5].lon]).addTo(mappa);
...
const Bistrot901 = L.marker([dati[6].lat, dati[6].lon]).addTo(mappa);
...
const MuseodArteContemporaneaFolligeniali = L.marker([dati[7].lat, dati[7].lon]).addTo(mappa);
...
const RistoranteAltaMarea = L.marker([dati[8].lat, dati[8].lon]).addTo(mappa);
...
const MuseoPaoloGorini = L.marker([dati[10].lat, dati[10].lon]).addTo(mappa);
...
const RistoranteLaPetiteMondina = L.marker([dati[11].lat, dati[11].lon]).addTo(mappa);
...
const MuseodelloStrumentoMusicale = L.marker([dati[12].lat, dati[12].lon]).addTo(mappa);
...
const RistoranteAlSazio = L.marker([dati[13].lat, dati[13].lon]).addTo(mappa);
...
const MuseodiocesanoArteSacra = L.marker([dati[14].lat, dati[14].lon]).addTo(mappa);
...
const BarCavour = L.marker([dati[15].lat, dati[15].lon]).addTo(mappa);
